...
HoverButton(f2, text="Next", cursor="hand2", command=des_f2, width=10, border=4).place(x=500, y=300)
HoverButton(f2, text="Clear", cursor="hand2", command=clear1, width=10, border=4).place(x=600, y=300)
